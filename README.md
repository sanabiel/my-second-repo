...
- Class Selector
    Class Selector digunakan untuk memilih elemen HTML berdasarkan kelas yang diberikan pada elemen tersebut. Kelas dinyatakan dengan menggunakan tanda titik (.) sebelum nama kelas. Manfaat dari menggunakan class selector antara lain bisa untuk mengelompokkan elemen berdasarkan fungsionalitas atau gaya tertentu, menerapkan gaya yang sama pada banyak elemen di halaman web hanya dengan memberikan kelas yang sama kepada elemen tersebut, dan memudahkan user untuk merencanakan dan menerapkan berbagai gaya dan tema secara konsisten pada elemen-elemen yang memiliki fungsionalitas atau penampilan yang mirip.
    Class Selector biasa digunakan ketika ingin menerapkan gaya yang sama pada beberapa elemen di halaman web dan ketika ingin mengelompokkan elemen dengan tampilan yang sama. 
- ID Selector
    ID selector dalam CSS digunakan untuk memilih dan menerapkan gaya pada elemen HTML yang memiliki atribut ID tertentu. Beberapa manfaat dalam menggunakan adalah untuk  secara spesifik memilih satu elemen HTML dengan ID unik. Lalu juga untuk membuat ancor (bookmark) dalam halaman web dan membuat link ke bagian tertentu dalam satu halaman, dengan menggunakan atribut href yang berisi tanda “#” diikuti oleh nama id. ID selector sebaiknya digunakan ketika ingin memberikan gaya khusus pada elemen HTML yang hanya ada satu pada halaman atau ketika membuat link ke bagian tertentu dalam satu halaman.
...
Untuk pemilihan penggunaannya, jika ingin membangun antarmuka dengan cepat menggunakan komponen siap pakai, Bootstrap mungkin menjadi pilihan terbaik. Namun, jika ingin membangun antarmuka dengan desain khusus atau ingin mengoptimalkan performa halaman web, Tailwind mungkin menjadi pilihan terbaik.
...
Dalam synchronous programming, tindakan-tindakan dilakukan secara berturut-turut, satu demi satu. Tindakan selanjutnya harus menunggu penyelesaian tindakan sebelumnya sebelum dapat dimulai. Ini berarti bahwa program akan mengalami penundaan atau tidak dapat melakukan tindakan apapun selama proses tindakan berlangsung. Manfaat dari synchronous programming adalah bahwa program lebih mudah dalam penulisan dan pemahamannya, karena alur eksekusi sesuai dengan urutan kode. Tetapi, kelemahan dari synchronous programming adalah bahwa program dapat terasa lambat dan kurang responsif, terutama jika tindakan memerlukan waktu yang lama atau jika terjadi kesalahan.

Sementara dalam asynchronous programming, tindakan dapat dilakukan secara bersamaan atau tanpa harus menunggu penyelesaian tindakan lainnya. Tindakan selanjutnya dapat dimulai sebelum tindakan sebelumnya selesai, atau tindakan dapat dijalankan di latar belakang tanpa menghambat alur utama program. Ini berarti bahwa program tidak akan mengalami penundaan atau dapat melakukan tindakan lain selama proses tindakan berlangsung. Keuntungan dari asynchronous programming adalah bahwa program dapat lebih cepat dan responsif, karena dapat memaksimalkan pemanfaatan sumber daya yang tersedia. Tetapi, kelemahan dari asynchronous programming adalah bahwa program lebih sulit dalam penulisan dan pemahamannya, karena alur eksekusi tidak sesuai dengan urutan kode dan membutuhkan mekanisme khusus untuk mengelola hasil atau kesalahan dari tindakan.

# 2. Dalam penerapan JavaScript dan AJAX, terdapat penerapan paradigma event-driven programming. Jelaskan maksud dari paradigma tersebut dan sebutkan salah satu contoh penerapannya pada tugas ini.
Paradigma event-driven programming adalah paradigma pemrograman yang mengatur alur program berdasarkan peristiwa-peristiwa yang terjadi, seperti interaksi pengguna, keluaran sensor, atau pesan dari program atau thread lain. Dalam paradigma ini, program menunggu peristiwa terjadi sebelum melanjutkan eksekusi. Hal ini memungkinkan program lebih responsif karena tidak perlu terus-menerus menjalankan kode. Sebaliknya, program dapat menanggapi peristiwa yang sesuai dengan fungsi-fungsi khusus.
...
# 4. 
Berikut adalah beberapa perbedaan dan pertimbangan dalam memilih salah satu dari keduanya:
